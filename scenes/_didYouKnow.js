...
class DidYouKnowScene extends Phaser.Scene {
  ...
  preload () {
    ...
    //new background
    this.load.image('dyk_bk', getSceneImagesFolder() + 'did_you_know_backround.jpg');
    ...
    this.load.image('did_you_know_footer', getSceneImagesFolder() + 'did_you_know_footer.png');
  ...
  create () {
    ...
    this.add.image(959, 1022, 'did_you_know_footer').depth = 50;
...
var randomDidYouKnowList = new Array();
...
function showDidYouKnowAnswer(){
  if (didYouKnowList.length > 0) {
    ...
    dyk_photo.visible = true;
    dyk_slogan.visible = true;
    dyk_postit.visible = true;
